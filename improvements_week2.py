...
def find_optimal_threshold_for_pauc(y_true, y_pred_proba, target_specificity=0.95, 
                                     specificity_range=(0.90, 1.0)):
    """
    ...
    for idx in valid_indices:
        ...
        if spec_diff < best_spec_diff or (spec_diff == best_spec_diff and tpr[idx] > best_sensitivity):
