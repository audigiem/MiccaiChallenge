...
def plot_training_history(history_dict, save_path=None):
    ...
    axes[1, 1].plot(history_dict['val_precision'], label='Val Precision', linestyle='--')
...
def visualize_predictions(model, dataset_df, num_samples=9, image_size=384, save_path=None):
    """
