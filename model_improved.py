...
def create_improved_model(
    ...
    model = models.Model(inputs=inputs, outputs=outputs, name=f"AIROGS_improved_{backbone}")
...
def unfreeze_backbone(model, num_layers=50):
    ...
    print(f"   Total layers: {total_layers}, Frozen: {freeze_until}, Trainable: {num_layers}")
